      ...
      {!imageError ? (
        <>
          <Image
            ...
            width={120}
            height={60}
            className={`object-contain max-h-16 max-w-24 transition-opacity duration-300 ${
          ...
          {!imageLoaded && !imageError && (
            <div className="absolute w-16 h-16 bg-gradient-to-br from-primary-500 to-primary-600 rounded-lg flex items-center justify-center shadow-md animate-pulse">
